...
<%
	...
	if(uid.equals(pwd)){	// 시뮬레이션화
		//로그인 성공했다면
		//id값을 전체 페이지에서 활용하기 위해서 세션을 하나 만들어서 담을것이다.
		session.setAttribute("member", uid);	// 세션객체의 변수 member는 전체 웹사이트 페이지에서 사용가능하다.
		success = true;
	} 
%>    
<!DOCTYPE html>
...
%>
		<script type="text/javascript">
			...
			// window.history.go(-1); 이전페이지로 갈 수도 있다.
		</script>
<%
	}
%>
