...
<%
	...
	// 모든 페이지에서 사용하고 싶을때
	session.setAttribute("empobj", emp);	// session.setAttribute(의 두번쨰 파라미터) -> Array, Collection등이 사용 가능..
	...
	request.setAttribute("who", "king");	//request 이건 현재페이지에서만 쓸 수 있다.
											//만약 다른페이지 쓰고 싶다면 (include, forward)
%>
